...
@Injectable()
export class BillItemsService extends BaseService<BillItems, BillItemRepository> {
    constructor(
    ...
    async addBillItems(addData: any) {
        let data = addData.map(item => item)
        ...
        return this.getBillItemById(addData[0].billId)
    }
